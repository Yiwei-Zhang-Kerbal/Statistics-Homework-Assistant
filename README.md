...
Python files including:
  ...
  3. Monocolor text version  
The .exe file is packed from the colored text version, and only be provided after v.0.1.15.Alpha  
This program is still developing, feel free to submit issues.  
